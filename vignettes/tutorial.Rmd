...
We can see that most body sizes are less than 10. 
...
Edwards recommends two plots to display body size data and size spectra estimates. The `sizeSpectra` package has a function `MLE.plots.recommend()` which  
